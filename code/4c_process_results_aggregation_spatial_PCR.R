...
load('../output/3f_revised_p_spatial_monthly_aggregated.RData')
...
f = '../output/4f_p_distribution_overall.RData'
if(!file.exists(f)){
  for(tt in 1:nrow(zik_c)){
...
# pdf('../output/supp/supp_4f_revised_p_distributions_spatially_monthly_aggregated.pdf',
#     height = 6, width = 6)
...
# pdf('../output/supp/supp_violin_spatially_monthly_aggregated_PCR.pdf', 
#     width = 8, height = 6)
layout(matrix(1:3, nrow = 3))
...
# pdf('../output/supp/supp_f_misdiagnosed_zika_region_spatial_monthly_aggregation.pdf', 
#     height = 6, width = 8.5)
