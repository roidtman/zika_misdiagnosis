...
for(cc in 1:length(countries)){
    ...
    diag_c_time_country_1_2 = lapply(1:num_samples, function(ff) 
      diag_dist_igg[lapply(p_prime_Zc_samples[,cc], constrain_diag_1_2, diag_dist_igg)[[ff]],])
...
save(p_Zs, p_Zc, file = '../output/3b_revised_p_temporal_aggregated_confirmed-igm.RData')
