...
for(tt in 1:nrow(zik_c)){
  ...
  diag_c_time_country_1_2 = lapply(1:num_samples, function(ff) 
    diag_dist_igg[lapply(p_prime_Zc_samples[,tt], constrain_diag_1_2, diag_dist_igg)[[ff]],])
...
save(p_Zs, p_Zc, file = '../output/3f_revised_p_spatial_monthly_aggregated_confirmed-igm.RData')
